...
const getStatusInfo = (status) => {
  switch (status) {
    case "active":
      return { text: "פעיל", hebrewText: "פעיל", color: "#28a745" };
    case "waiting":
      return { text: "ממתין", hebrewText: "בתור להקצאה", color: "#f0ad4e" };
    case "reserved":
      return { text: "הוזמנה", hebrewText: "שמור", color: "#dc3545" };
    default:
      return { text: "פעיל", hebrewText: "פעיל", color: "#28a745" };
  }
};
        ...
        <div className="own-parking-header">
          <div className="header-content">
            <div className="header-text">
              ...
              <p className="header-title-english">החניה שלך</p>
            </div>
          ...
          >
            {isNavigating ? (
              ...
              <>
                ...
                <span>{hasValidCoordinates ? "נווט" : "מיקום לא זמין"}</span>
              </>
            )}
          </button>

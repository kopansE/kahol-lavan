  ...
  const renderReport = ({ item }) => (
    <View style={styles.reportCard}>
      <View style={styles.reportHeader}>
        <Text style={styles.reportType}>{getReportTypeLabel(item.report_type)}</Text>
      ...
      <Text style={styles.reportUser}>Reported: {item.reported_user_name}</Text>
      ...
      {item.status === 'resolved' && item.resolution_notes && (
        <View style={styles.resolutionBox}>
          <Text style={styles.resolutionText}>
            ...
            {item.action_taken && (
              <Text style={styles.actionTaken}> ({item.action_taken.replace('_', ' ')})</Text>
            )}
          </Text>
        </View>
      )}
